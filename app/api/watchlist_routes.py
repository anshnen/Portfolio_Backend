...
@watchlist_bp.route('/<int:watchlist_id>/items/<int:asset_id>', methods=['DELETE'])
def remove_item_route(watchlist_id, asset_id):
    try:
        watchlist_service.remove_item_from_watchlist(watchlist_id, asset_id)
